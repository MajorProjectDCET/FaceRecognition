...
def faceDetection(test_img):
    ...
    face_haar = cv2.CascadeClassifier(r'D:\Face Recognition Project\FaceRecognition\haarcascade_frontalface_alt.xml')  # Give path to haar classifier as i have given
